...
- **[SnowSQL CLI](https://developers.snowflake.com/snowsql/)** installed on your local machine. This is the command line client for connecting to Snowflake to execute SQL queries and perform all DDL and DML operations.
