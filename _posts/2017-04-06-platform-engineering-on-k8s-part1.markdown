...
- **Argo Workflows:** Argo Workflows, a powerful container-native workflow engine, will serve as our CI/CD pipelining solution.These will include cloud resource provisioning, configuration, and application deployments. Through Argo Workflow templates, we will create Terraform tasks for provisioning and Ansible scripts for configuration. You can read more **[here](https://argoproj.github.io/workflows/)**
